...
Rails.application.configure do
  ...
  # Store uploaded files on S3/R2 in production. Set ACTIVE_STORAGE_SERVICE=amazon or cloudflare_r2.
  ...
  app_host = ENV["APP_HOST"].presence || ENV["RENDER_EXTERNAL_HOSTNAME"].presence || "example.com"
  ...
  if ENV["APP_HOST"].present?
    ...
    config.hosts << /.*\.#{Regexp.escape(ENV["APP_HOST"])}\z/
  end
